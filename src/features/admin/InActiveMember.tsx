...
import { approveApplication, getInactiveMembers, viewMember } from "./adminSlice";
...
const InActiveMembers = () => {
  ...
  const handleApproveApplication = async (id: string) => {
    ...
    if (!requestError) {
      await dispatch(getInactiveMembers()).unwrap();
      return true;
    }
  ...
  return (
    <div>
      ...
      </div>: <div className="text-center">NO INACTIVE MEMBER</div>}
      {
