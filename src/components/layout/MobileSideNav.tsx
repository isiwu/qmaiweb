...
const MobileSideNav = ({iconName, text, disabled=false, href, setShowMenu}: AppProps) => {
  ...
  const handleClick = async (evt: MouseEvent) => {
    ...
    // const currEl = evt.target as Element;
    // currEl.className += " rounded-tl-full rounded-bl-full"
