...
const AdminDashboardItem = ({icon,text, disabled=false, handleClick, className}: AppProps) => {
  const user = useAppSelector(state => state.user.data);

  return (
    <div className={classNames(`flex flex-col justify-center items-center border-[1px] border-[#CCCCCC] rounded-md ${className}`, {
