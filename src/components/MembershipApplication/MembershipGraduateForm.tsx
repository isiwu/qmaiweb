...
const GraduateForm = ({applicationType, formData, handleChange, handleChangeSelect, handleClick}: AppProps) => {
    ...
    <div>
      <div>
        ...
        <div className="flex items-center my-8 space-x-4 px-4">
          ...
          <label htmlFor="studying" className="font-[10] leading-[18px] text-[#676767] hover:cursor-pointer text-[18px]">Currently studying a QMSAI qualification or a QMSAI accredited higher education course or studying management system auditing related course.</label>
        </div>
        ...
        <div className="flex items-center space-x-4 my-5 px-4">
          ...
          <div className="text-[#CCCCCC] text-[14px]">For anyone enrolled on a QMSAI accredited higher education course or studying management system auditing related course.</div>
        </div>
      </div>
      ...
      <div className="">
        ...
        <hr />
        <div className="flex items-center space-x-2 my-6 px-4">
          <div><RiErrorWarningFill /></div>
          <div className="text-[#CCCCCC] text-[14px]">Graduate Membership application is free other membership would to pay an application fee as sign in the system</div>
        </div>
        <div className="flex flex-col space-y-2 px-4 mt-8">
          ...
          <input type="text" id="" className="bg-[#FBFBFB] w-[216px] h-[48px] outline-none rounded-lg text-[#272727] font-[400] text-[18px] placeholder:text-[#272727]" value={"$ 0.00"} readOnly  />
        </div>
      </div>
      <div className="flex justify-center items-center mt-16 px-4">
        <ApplicationButton text={"Submit Application"} handleClick={handleSumbit} disabled={showModal?true:membershipStatus === "loading"?true:false} />
      </div>
    </div>
  )
}
